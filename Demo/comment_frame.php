...
<body>
	...
	<!--the name of the submit button contains id, becasue this form will be to all posts, to make it unique, we write for every post the name with the id of this post-->
